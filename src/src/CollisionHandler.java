        ...
        for (int i = 0; i < game_objects.size(); i++) {
            ...
            for (int j = i; j < game_objects.size(); j++) {
                ...
                if (i != j) {
                    ...
                    if (((obj_at_j instanceof Bullet && obj_at_i instanceof src.Wall2 && !((Bullet) obj_at_j).collided))) {
                        if (obj_at_i.my_rectangle.intersects(obj_at_j.my_rectangle)) {
                            obj_at_j.collision();
                            obj_at_i.collision();
                        }
                    ...
                    if (obj_at_i instanceof Tank && obj_at_j instanceof src.Wall2) {
                    ...
                    if (obj_at_i instanceof src.Wall2 && obj_at_j instanceof Tank) {
